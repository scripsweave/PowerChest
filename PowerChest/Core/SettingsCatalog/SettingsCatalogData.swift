...
enum SettingsCatalogData {
    ...
    static let allGroupedControls: [GroupedControlDefinition] = [
        ...
        // G053 — Background app behavior (multi-toggle)
        GroupedControlDefinition(
            id: "G053",
            title: "Background app behavior",
            subtitle: "macOS secretly pauses and terminates idle apps to save energy. Disable these if background tasks keep stalling or apps keep disappearing.",
            category: .internals,
            kind: .multiToggle,
            backingSettingIDs: ["global.appNap", "global.preventAutoTermination"],
            options: nil
        ),
        ...
        // G070 — Sidebar & scroll bars (multi-control card)
        GroupedControlDefinition(
            id: "G070",
            title: "Sidebar & scroll bars",
            subtitle: "Change sidebar icon size and scroll bar click behavior.",
            category: .interface,
            kind: .multiControl,
            backingSettingIDs: [
        ...
        // G079 — Window tabbing & drag (multi-control card)
        GroupedControlDefinition(
            id: "G079",
            title: "Window tabbing & drag",
            subtitle: "Control whether new windows open as tabs, and drag windows from anywhere with Ctrl+Cmd.",
            category: .windowsSpaces,
            kind: .multiControl,
            backingSettingIDs: [
